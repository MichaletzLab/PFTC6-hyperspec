...
#Capitalized first letter of each site name
allspectra_ordered$siteID <- paste0(
  toupper(substr(allspectra_ordered$siteID, 1, 1)),
  substr(allspectra_ordered$siteID, 2, nchar(allspectra_ordered$siteID))
)
#write dataset
